...
with tab_chart:
    if not filtered_df.empty:
        st.markdown("### 📊 กราฟ Altair: จำนวนโครงการตามรูปแบบงบประมาณในแต่ละปี")
        ...
        chart = alt.Chart(chart_data).mark_bar().encode(
            x=alt.X("ปีงบประมาณ:N", title="ปีงบประมาณ"),
            y=alt.Y("จำนวนโครงการ:Q", title="จำนวนโครงการ"),
            color=alt.Color("รูปแบบงบประมาณ:N", title="รูปแบบงบประมาณ"),
            tooltip=["ปีงบประมาณ", "รูปแบบงบประมาณ", "จำนวนโครงการ"]
        ).properties(
            width="container",
            height=400
        )
